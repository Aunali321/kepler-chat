...
export function ToolSelector({ enabledTools, onToolsChange }: ToolSelectorProps) {
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case 'search': return 'bg-green-100 text-green-700';
      case 'computation': return 'bg-purple-100 text-purple-700';
        ...
        <>
          ...
          <div className="absolute top-full left-0 mt-2 w-80 bg-white border rounded-lg shadow-lg z-20 max-h-96 overflow-y-auto">
            ...
            <div className="p-3 border-t bg-gray-50 text-xs text-gray-600">
              💡 Tools help the AI perform specific tasks like calculations, web searches, and code execution
            </div>
          </div>
        </>
      )}
