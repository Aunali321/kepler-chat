...
if __name__ == "__main__":
    ...
    print("Type your sub-prompt, or one of: 'TASK_COMPLETE', 'Done', 'Quit', 'q' to signal completion.",
          flush=True)  # MODIFIED
    ...
    while active_session:
        try:
            ...
            if not line:  # EOF
                print(
                    "--- REVIEW GATE: STDIN CLOSED (EOF), EXITING SCRIPT ---", flush=True)
            ...
            print(
                "--- REVIEW GATE: SESSION INTERRUPTED BY USER (KeyboardInterrupt) ---", flush=True)
            active_session = False
            break
